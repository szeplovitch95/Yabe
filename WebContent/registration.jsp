		...
		<form class="form-horizontal" action="insertEndUser.jsp" method="post">
			<fieldset>
				...
				<div class="form-group">
					<label class="control-label col-md-2 col-sm-2 col-lg-2">First
						Name:</label>
				...
				<div class="form-group">
					...
					<div class="col-md-5 col-lg-5 col-sm-5">
						<input class="form-control" type="text" name="username"
							placeholder="Username" pattern="^[a-zA-Z][a-zA-Z0-9-_\.]{1,20}$"
							required />
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="control-label col-md-2 col-sm-2 col-lg-2">Phone
						Number:</label>
					<div class="col-md-5 col-lg-5 col-sm-5">
			...
			<fieldset>
				...
				<div class="form-group">
					<label class="col-sm-2 col-md-2 col-lg-2 control-label"
						for="card-type">Credit Card Type:</label>
				...
				<div class="form-group">
					<label class="col-md-2 col-sm-2 col-lg-2 control-label"
						for="expiry-month">Expiration Date</label>
					<div class="col-md-5 col-lg-5 col-sm-5">
						<div class="row">
