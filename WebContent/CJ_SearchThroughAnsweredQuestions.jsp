...
<form id="contact_form" action="CJ_QuestionSubmitted.jsp" method="post" >
	...
	<div class="form-group">
		...
		<input id="name" class="form-control" name="name" type="text" size="30" /><br />
	</div>
	
	<div class="form-group">
		<label for="password">Password:</label><br />
		<input id="password" class="form-control" name="password" type="password" size="30" /><br />
	</div>
	
	<div class="form-group">
		<label for="question">Question:</label><br />
		<textarea id="question" class="form-control" name="question" rows="7" cols="30"></textarea><br />
	</div>
